import torch
from DiffusionFields.se3dif.utils import directory_utils
from isaacgym import gymapi, gymtorch
import os, os.path as osp
import numpy as np
from scipy.spatial.transform import Rotation as R

from evaluation.utils.geometry_utils import H_2_Transform
...
class GripperOnly():
    ...
    def set_action(self, action):
        ...
        if 'hand_control_type' in  action:
            ...
            if action['hand_control_type']=='position':
            ...
            elif action['hand_control_type']=='orientation':
                ## Set desired position displacement
                hand_xyzw = action['des_hand_position']          #needs to be xyzw
                ...
                # print('target pos: ({}, {}, {}), target ori: ({} {} {} {})'.format(pose.p.x, pose.p.y, pose.p.z,
                #                                                                    pose.r.x, pose.r.y, pose.r.z, pose.r.w))
                pose.r.x = hand_xyzw[0]
                pose.r.y = hand_xyzw[1]
                pose.r.z = hand_xyzw[2]
                pose.r.w = hand_xyzw[3]
                self.gym.set_attractor_target(self.env, self.attractor_handle, pose)
            
            elif action['hand_control_type']=='random':
                ## Set desired position displacement
                hand = action['des_hand_position']          #needs to be xyzw
