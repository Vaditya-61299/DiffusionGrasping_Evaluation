...
from DiffusionFields.se3dif.models.vision_encoder.common import normalize_coordinate, normalize_3d_coordinate, map2local
...
class LocalDecoder(nn.Module):
    ...
    def sample_grid_feature(self, p, c):
        p_nor = normalize_3d_coordinate(p.clone() / self.scale, padding=self.padding) # normalize to the range of (0, 1)
