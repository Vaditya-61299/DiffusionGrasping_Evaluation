...
from DiffusionFields.se3dif.utils import get_root_src

import torch
from torch.utils.data import DataLoader

from DiffusionFields.se3dif import datasets, losses, summaries, trainer
from DiffusionFields.se3dif.models import loader

from DiffusionFields.se3dif.utils import load_experiment_specifications

from DiffusionFields.se3dif.trainer.learning_rate_scheduler import get_learning_rate_schedules
...
def parse_args():
    ...
    p.add_argument('--spec_file', type=str, default='graspdif'
                   , help='root for saving logging')
